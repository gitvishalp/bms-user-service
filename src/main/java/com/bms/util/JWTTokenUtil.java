...
public class JWTTokenUtil {
    ...
    private static String JWT_SECRET = "bms[VwNp-8zK9-0j6714dk{}+VsqSk;;cd0";
    ...
    public String generateToken(String phoneNumber, String userId, String email, String ipAddress) {
