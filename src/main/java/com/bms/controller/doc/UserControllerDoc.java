...
public interface UserControllerDoc extends Serializable {
	...
	Response<AddressResponse> updateAddress(@Parameter(hidden=true)String token, AddressRequest request);
	...
	Response<String> resetPassword(@Parameter(name="UserKey")String u,ChangePasswordRequest request);
}
